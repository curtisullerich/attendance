...
public class DirectorServlet extends AbstractBaseServlet {
	...
	private void viewEvent(HttpServletRequest req, HttpServletResponse resp)
		...
		if (sid != null && !sid.equals("")) {
			try {
				Event event = train.getEventManager().get(
						Long.parseLong(sid));
	...
	private void postDirectorInfo(HttpServletRequest req,
		...
		String success = null;
		User director = train.getAuthManager().getCurrentUser(
				req.getSession());
		List<String> errors = new ArrayList<String>();
	...
	private void deleteStudent(HttpServletRequest req, HttpServletResponse resp)
		...
		List<String> errors = new ArrayList<String>();
		if (sid != null) {
			UserManager uc = DataTrain.getAndStartTrain()
					.getUsersManager();
