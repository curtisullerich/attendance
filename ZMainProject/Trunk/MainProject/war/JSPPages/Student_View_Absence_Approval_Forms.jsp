...
<html>
	...
	<h3>
		<li>
			...
			>
			<a href="http://www.iastate.edu" title="PageTrail_AbsenceApprovalForm_ViewAttendance">View Attendance</a>
			>
			<a href="http://www.iastate.edu" title="PageTrail_SubmittedAbsenceForms">Submitted Absence Forms</a>
	...
	<!--*********************info*****************************-->
		...
		<h1>NetID, Student Name--class conflcit1</h1>
	...
	<!--*********************End Button*****************************-->
				...
				<h2>
					...
					<input type="checkbox" name="approve" checked >Approved</input>
