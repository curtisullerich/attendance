...
<!--*********************info*****************************-->
	...
	<div>
		<table border="1">
			...
			<tr><td><button>View</button></td><td>Class Conflict</td> <td>8/31</td><td>12/2</td><td>Yes</td></tr>
			<tr><td><button>View</button></td><td>Class Conflict</td> <td>8/31</td><td>12/2</td><td>NO</td></tr>
		</table>
	</div>
