...
<html>
	...
	<body>
		...
		ending January 9, ${year+1}, and it must be submitted by 4:30 p.m. on Monday, August
		23, ${year}.  Documentation must be submitted to the director for all absences (doctor's note, obituary, wedding program, etc.).</p>
